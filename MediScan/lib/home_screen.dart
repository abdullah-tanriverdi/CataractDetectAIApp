...
import 'package:mediscan/cataract_eye_screen.dart';
import 'package:mediscan/flu_eye_screen.dart';
import 'package:mediscan/info_screen.dart';
import 'package:mediscan/lung_tomography_screen.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<CardItem> items = [
      CardItem(
        title: "Cataract Eye",
        description: "Detect cataracts with a quick eye test. For more details, visit the full section.",
        assetPath: "assets/cataract_eye.png",
        destinationScreen: const CataractEyeScreen(),
      ),
      CardItem(
        title: "Lung Tomography",
        description: "We detect lung conditions through advanced tomography scans. For more details, visit the full section.",
